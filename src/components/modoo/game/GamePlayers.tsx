...
import {
  ReceiveButton,
  SendButton,
} from "@/components/modoo/game/GameActionButton"
import { ModooGameStatus, type ModooPlayer } from "@/domain/modoo"
    ...
    <div className="flex min-w-0 gap-x-4 w-full">
      <div className="min-w-0 flex-auto grow">
        <div className="flex w-full gap-x-2">
          ...
          <p className="text-xl font-semibold leading-6">{player.name}</p>
        </div>
